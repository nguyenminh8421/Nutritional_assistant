...
import 'package:demo_1/controller/breakfast_controller.dart';
import 'package:demo_1/controller/dinner_controller.dart';
import 'package:demo_1/controller/lunch_controller.dart';
import 'package:demo_1/database/background.dart';
import 'package:demo_1/screen/import_food/breakfast_import.dart';
import 'package:demo_1/screen/import_food/dinner-import.dart';
...
class Dinner extends StatelessWidget {
  ...
  final DinnerController dinnerController = Get.put(DinnerController());

  @override
  Widget build(BuildContext context) {
    dinnerController.fetchTodayDinnerId();
    return Scaffold(
      appBar: AppBar(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            ...
                            Get.to(DinnerImport(), arguments: food);
                          },
                        ),
                      ),
                    );
